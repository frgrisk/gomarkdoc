...
func TestPackage_dotImport(t *testing.T) {
	...
	is.Equal(pkg.Import(), `import "github.com/frgrisk/gomarkdoc/testData/lang/function"`)
	is.Equal(pkg.ImportPath(), `github.com/frgrisk/gomarkdoc/testData/lang/function`)
}
